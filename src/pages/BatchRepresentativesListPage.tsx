  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl xl:text-3xl font-bold">Batch Representatives</h1>
          <p className="text-sm lg:text-base text-gray-600 mt-1">Manage batch representatives</p>
        </div>
